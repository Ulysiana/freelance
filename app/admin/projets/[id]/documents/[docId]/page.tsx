...
export default function DocumentEditPage() {
  ...
  async function handleDelete() {
    ...
    router.push(`/admin/projets/${id}/documents`)
  }
  ...
  return (
    <div style={{ maxWidth: 800 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 20, fontSize: 12, color: 'rgba(240,235,228,0.35)' }}>
        ...
        <Link href={`/admin/projets/${id}`} style={{ color: 'rgba(240,235,228,0.35)', textDecoration: 'none' }}>{doc.project.name}</Link>
        <ChevronRight size={12} strokeWidth={1.5} />
        <Link href={`/admin/projets/${id}/documents`} style={{ color: 'rgba(240,235,228,0.35)', textDecoration: 'none' }}>Documents</Link>
        <ChevronRight size={12} strokeWidth={1.5} />
