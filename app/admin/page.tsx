      ...
      {open && client.projectsAsClient.length > 0 && (
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.04)', padding: '10px 16px', display: 'flex', flexDirection: 'column', gap: 4 }}>
          {client.projectsAsClient.map(p => (
            <Link key={p.id} href={`/admin/projets/${p.id}`} style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 10, padding: '8px 12px', borderRadius: 8, background: 'rgba(255,255,255,0.02)' }}>
              ...
              {recentRequests.length === 0 ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {recentRequests.map(r => (
                    <Link key={r.id} href={`/admin/projets/${r.project.id}/demandes`} style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', gap: 2, padding: '10px 12px', borderRadius: 8, background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            {recentMessages.length === 0 ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                {recentMessages.map(m => (
                  <Link key={m.id} href={`/admin/projets/${m.project.id}/messages`} style={{ textDecoration: 'none', display: 'flex', gap: 12, padding: '10px 12px', borderRadius: 8, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)', alignItems: 'flex-start' }}>
